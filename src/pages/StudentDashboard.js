...
// import toast from 'react-hot-toast'; // <-- 'यह' (This) 'लाइन' (line) (पंक्ति) 'हटा' (Removed) 'दी' (did) 'गई' (was) 'है' (है) 'क्योंकि' (because) '`FindSenior`' (सीनियर खोजें) '`में`' (in) '`toast`' (टोस्ट) (toast) '`का`' (of) '`इस्तेमाल`' (use) ('इस्तेमाल' (Use) (उपयोग)) '`नहीं`' (not) ('नहीं' (Not) (नहीं)) '`हो रहा था`' (was being) (हो (is being) 'रहा' (is) 'था' (was))
