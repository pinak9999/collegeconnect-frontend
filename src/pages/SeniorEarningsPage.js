  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setPlatformFee(settingsRes.data.platformFee || 20);
      } catch (err) {
        console.error(err);
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "20px" }}>
        ...
        <p style={{ color: "#4B5563", fontSize: "14px" }}>
          Track your performance, completed calls & upcoming payouts.
        </p>
      </div>
              ...
              >
                ...
                <p style={{ color: "#6B7280", fontSize: "13px", marginBottom: "4px" }}>
                  ...
                  {booking.date
                    ...
                    : booking.slot_time
                    ? new Date(booking.slot_time).toLocaleDateString()
                    : "N/A"}
                </p>
                ...
                <p
                  style={{
                    color:
                      booking.payout_status === "Paid" ? "#10B981" : "#6B7280",
                    fontWeight: "600",
                    marginBottom: "5px",
                  }}
                >
